...
export const createEmptyParams = () => ({
  global: {
    ...
    seed: 1,
    runTimes: 1,
    logEveryEvaluations: 10,
    wsUpdateEveryEvaluations: 100,
...
function buildGlobalParamsFromRunRequest(runRequest) {
  return {
    ...
    logEveryEvaluations: runRequest.logEveryEvaluations || 100,
    wsUpdateEveryEvaluations: runRequest.wsUpdateEveryEvaluations || 100,
    problemSizes: "100, 200, 400, 800",
    repetitionsPerSize: 10,
    wsUpdateEverySizes: 1,
  };
