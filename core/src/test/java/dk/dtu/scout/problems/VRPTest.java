...
class VRPTest {
    ...
    void totalDistance_sumsRouteDistances() {
        ...
        double total = problem.totalDistance(List.of(
            List.of(0),
            List.of(1)
        ));
    ...
    void vehiclePenalty_isZeroWhenVehicleLimitIsRespected() {
        ...
        assertEquals(0.0, problem.vehiclePenalty(List.of(
            List.of(0),
            List.of(1)
        )), 1e-9);
    }
    ...
    void vehiclePenalty_penalizesExcessVehicles() {
        ...
        assertEquals(1_000_000.0, problem.vehiclePenalty(List.of(
            List.of(0),
            List.of(1)
        )), 1e-9);
    }
    ...
    void fitness_includesVehiclePenalty() {
        ...
        double fitness = problem.fitness(List.of(
            List.of(0),
            List.of(1)
        ));
    ...
    void fitness_rejectsUnconfiguredProblem() {
        ...
        assertThrows(IllegalStateException.class, () ->
            problem.fitness(List.of(List.of(0, 1)))
        );
    }
    ...
    void fitness_rejectsEmptyRoutesAfterNormalization() {
        ...
        assertThrows(IllegalArgumentException.class, () ->
            problem.fitness(List.of())
        );

        assertThrows(IllegalArgumentException.class, () ->
            problem.fitness(List.of(List.of(), List.of()))
        );
    }
    ...
    void fitness_rejectsCustomerIndexBelowRange() {
        ...
        assertThrows(IllegalArgumentException.class, () ->
            problem.fitness(List.of(List.of(-1, 0)))
        );
    }
    ...
    void fitness_rejectsCustomerIndexAboveRange() {
        ...
        assertThrows(IllegalArgumentException.class, () ->
            problem.fitness(List.of(List.of(0, 2)))
        );
    }
    ...
    void fitness_rejectsMissingCustomer() {
        ...
        assertThrows(IllegalArgumentException.class, () ->
            problem.fitness(List.of(List.of(0)))
        );
    }
